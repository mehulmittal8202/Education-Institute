# 1. डेस्कटॉप पर नया फोल्डर बनाएं और उसमें जाएं
cd ~\$HOME\Desktop
mkdir nextjs-portal
cd nextjs-portal

# 2. प्रोजेक्ट का बुनियादी ढांचा तैयार करें
mkdir -p src/app/api/register
mkdir -p src/app/api/check-result
mkdir -p src/app/online-registration
mkdir -p src/app/results
mkdir -p src/lib
mkdir -p public/images
mkdir -p public/prospects

# 3. .env.local फ़ाइल बनाएं
@"
DB_HOST=localhost
DB_USER=root
DB_PASSWORD=your_password
DB_NAME=study_center_db
NEXT_PUBLIC_SITE_NAME="Study Center Portal"
"@ | Out-File -Encoding utf8 .env.local

# 4. src/lib/db.js फ़ाइल बनाएं
@"
...
"@ | Out-File -Encoding utf8 src/lib/db.js

# 5. src/app/layout.js फ़ाइल बनाएं
@"
